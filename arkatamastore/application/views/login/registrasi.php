...
<head>
    ...
    <title>Arkatama Store - Registrasi</title>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4" style="color: red;">Daftar Akun</h5>
                                        <!-- <p class="text-center small">Masukkan detail pribadi Anda untuk membuat akun</p> -->
                                    </div>

                                    <?= $this->session->flashdata('message'); ?>

                                    <form class="row g-3 needs-validation" method="POST" action="<?= base_url('daftar'); ?>">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-sm w-100" id="subBtn" type="submit">Buat Akun</button>
                                        </div>
                                        <div class="col-12 text-center">
                                            <p class="small mb-0" >Sudah punya akun? <a href="<?= base_url('user/tampil_login') ?>" id="text1">Log in</a></p>
                                        </div>
                                    </form>
