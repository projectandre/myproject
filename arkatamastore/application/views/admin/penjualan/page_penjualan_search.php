                ...
                <div class="table-content table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr id="data-pesanan">
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            <?php if ($row_order->status == 'Ditolak' ) { ?>
                                    ...
                                    <td>
                                        <?php if ($row_order->bukti_transfer == '' || $row_order->status == 'ditolak' ) { ?>
                                            <a onclick='return confirm("Apakah anda yakin menghapus data ini?")' class='btn btn-danger' href='<?= base_url('penjualan/hapus_penjualan/' . $row_order->id_pemesanan); ?>'><i class="bi bi-trash"></i></a>
                                        <?php } else { ?>
                                            <a class="btn btn-success btn-sm" href="<?= base_url('penjualan/proses/' . $row_order->id_pemesanan); ?>">Proses</a>
                                            <?php if ($row_order->status == 'Ditolak' ) { ?>
                                            <a onclick='return confirm("Apakah anda yakin menghapus data ini?")' class="btn btn-danger btn-sm" href="<?= base_url('penjualan/hapus_penjualan/' . $row_order->id_pemesanan); ?>">Hapus</a><br>
                                            <?php } else { ?>
                                                <a class="btn btn-danger btn-sm" href="<?= base_url('penjualan/ditolak/' . $row_order->id_pemesanan); ?>">Tolak</a>
                                            <?php } ?>
                            ...
                            <?php } ?>
                            <?php } elseif ($data_ditolak) {  ?>

                                <?php $no = 1;
                            foreach ($data_ditolak as $row_order) {
                            ?>
                                <tr id="data-pesanan">
                                    <td><?= $row_order->tgl_pemesanan; ?></td>
                                    <td><?= $row_order->no_order; ?></td>
                ...
                <div class="table-content table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr id="data-pesanan">
                                    <td><?= $row_proses->tgl_pemesanan; ?></td>
                ...
                <div class="table-content table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?= $row_selesai->tgl_pemesanan; ?></td>
