                            ...
                            <li><a class="nav-link scrollto" href="<?= base_url() ?>user#contact">Kontak</a></li>
                             <?php if ($this->session->userdata('role_id') == '3') { ?>
                                ...
                                <li class="dropdown "><a href="#"><span>Lainnya</span> <i class="bi bi-chevron-down"></i></a>
                                    <ul>
                                      <li><a class="nav-link scrollto active" href="<?= base_url('user/tampilubahPasswordUser') ?>">Ganti Password</a></li>
                    ...
                    <div class="card mb-4 col-md-6">
                        <div class="card-body "><br>
                            <section class="content">
                                ...
                                ?>
                                    <form action="<?= site_url(); ?>user/ubah_passwordUser" method="POST">
                                        <div class="mb-3">
                                        ...
                                        <a href="<?= base_url('user'); ?>" style="margin-left: 10px;" class="btn btn-secondary float-right">Kembali</a>
                                    </form>
                                </section>
                        </div>
                    </div>
    ...
    <script>
        ...
        function myFunction() {
            ...
            if (document.getElementById("jumlah").validity.rangeUnderflow) {
                swal("Peringatan", "Anda Harus Mengisi Keranjang Minimal 1 Produk", "warning");
            } else if (document.getElementById("jumlah").validity.rangeOverflow) {
                swal("Peringatan", "Anda Harus Mengisi Keranjang Maksimal <?php echo $value->stok_barang; ?> Produk", "warning");
            }
             else {
