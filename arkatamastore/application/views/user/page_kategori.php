        ...
        <section id="portfolio" class="section-bg" style="margin-top: 75px;">
            <div class="container" data-aos="fade-up">
                ...
                <header class="section-header">
                    <h3 class="section-title">Produk/Layanan <br> Berdasarkan Kategori</h3>
                </header>
                    ...
                    <div class="col-md-8">
                        <div class="dropdown d-flex justify-content-end">
                            <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <?php
                                foreach ($judul as $key => $nilai) {
                                    echo $nilai['nama_kategori'];
                                }
                                ?>
                ...
                <div class="row text-center" id="contentProduk">
                    <?php foreach ($produk as $value) : ?>
                        <?php if ($value['status_produk'] == 'disetujui') { ?>
                            <div class="card mt-4 portfolio portfolio-wrap" style="width: 265px; margin: 0 auto;">
                                <img src="<?= base_url('uploads/') . $value['gambar_barang']; ?>" class="card-img-top" height="245" alt="Gambar kosong">
                                <div class="card-body">
                                    <h5 class="card-title" style="font-size: 16px;"><b><?= $value['nama_barang']; ?></b></h5>

                                    <small style="font-size: 12px;">Stok : <?= $value['stok_barang']; ?></small><br>
                                    <span class="badge rounded-pill text-bg-success mt-3 mb-3">Rp. <?= number_format($value['harga_barang'], 0, ',', '.');  ?></span>
                                    <br>
                                    <a href="<?= base_url('user/detail_produk/' . $value['id_barang']); ?>" class="btn btn-warning text-white btn-sm">Beli Produk</a>
                                </div>
                            </div>
                        <?php } ?>
                    <?php endforeach; ?>
