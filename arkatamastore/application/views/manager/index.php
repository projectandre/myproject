...
<head>
    ...
    <title>Arkatama Store - Manager</title>
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="<?= base_url('manager/'); ?>" class="logo d-flex align-items-center">
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="<?= base_url('manager/tampilUbahPassword') ?>">
                               <i class="bi bi-key"></i>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link <?= $this->uri->segment(1) == 'manager' && $this->uri->segment(2) == '' ? null : 'collapsed' ?>" href="<?= base_url('manager/'); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link <?= $this->uri->segment(2) == 'barang' ? null : 'collapsed' ?>" href="<?= base_url('manager/barang'); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link <?= $this->uri->segment(2) == 'hero' ? null : 'collapsed' ?>" href="<?= base_url('manager/hero'); ?>">
                    <i class="bi bi-window"></i>
                    <span>Kelola Hero</span>
                </a>
            ...
            <li class="nav-item">
                ...
                <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                  <li>
                    <a href="<?= base_url('admin/akun_user'); ?>" class="<?= $this->uri->segment(2) == 'akun_user' ? 'active' : null ?>">
                      <i class="bi bi-circle"></i><span>User/Customers</span>
                    </a>
                  </li>
                  <li>
                    <a href="<?= base_url('admin/akun_admin'); ?>" class="<?= $this->uri->segment(2) == 'akun_admin' ? 'active' : null ?>">
                      <i class="bi bi-circle"></i><span>Admin/Staff Penjualan</span>
                    </a>
                  </li>
                  <li>
                    <a href="<?= base_url('admin/akun_manager'); ?>" class="<?= $this->uri->segment(2) == 'akun_manager' ? 'active' : null ?>">
            ...
            <li class="nav-item">
                <a class="nav-link <?= $this->uri->segment(2) == 'laporan' ? null : 'collapsed' ?>" href="<?= base_url('manager/laporan'); ?>">
