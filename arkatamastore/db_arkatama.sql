...
--
-- Host: localhost:3306
-- Generation Time: Dec 21, 2022 at 12:01 AM
...
INSERT INTO `tabel_keranjang` (`id_keranjang`, `id_user`, `id_barang`, `jumlah`) VALUES
(11, 10, 2, 1),
(12, 10, 1, 1),
(16, 11, 5, 4);
...
INSERT INTO `tabel_penjualan` (`id_pemesanan`, `no_order`, `id_user`, `tgl_pemesanan`, `biaya_kirim`, `total_bayar`, `status`, `no_telp`, `alamat`, `kurir`, `jenis_ongkir`, `bukti_transfer`, `atas_nama`, `nama_bank`, `no_rekening`, `no_resi`) VALUES
...
(11, '318450', 10, '2022-12-20', 37000, 27035000, 'Diproses', '628576455098', 'Lampung', 'pos', 'Pos Reguler Pos Reguler', '1671547098-about.png', 'FAAA', 'BRI', '12121213123', '');
...
(9, 'Lala', 'lala@gmail.com', '$2y$10$747hDJ/oHaWton3IlJJVneWPFjwC3NxtU7fHqfgQenqUecopou.8i', 'default.jpg', 3),
(10, 'Nana', 'nana@gmail.com', '$2y$10$oFqzaj00pZUjaDVNoNY2oOOCqcvjLvTDSjwaGcvc6LE1wBWlStxc6', 'default.jpg', 3),
(11, 'vivi', 'vivi@gmail.com', '$2y$10$zlG1HHm16eiEVrV1BPez.eO19cJpqzUfV90MA3ezVt0h3xiJSUdxu', 'default.jpg', 3);
...
--
ALTER TABLE `tabel_detail_penjualan`
  MODIFY `id_detail_pemesanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
